                        ...
                        <tbody>
                          <tr v-for="(p,index) in filteredProcesses">
                            ...
                            <template v-for="(per,index) in periods_data">
                              ...
                              <td style="border-left: none;border-right: none;"><input type="number" min="0" style="width: 50px;" :name="'idletime_'+p.ProcessDailyHistoryId+'_'+per.PeriodId" @input="test" :value="findIdleVal(p,per.PeriodId)"></td>
                              ...
                              <td style="border-left: none;border-right: 2px solid gold;"><input type="text" min="0" style="width: 50px;" :name="'ucode_'+p.ProcessDailyHistoryId+'_'+per.PeriodId" @input="test" :value="findUcodeVal(p,per.PeriodId)"></td>
                            </template>
                          </tr>
                        </tbody>
                      </table>
