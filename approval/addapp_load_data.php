...
$arr['pos'] = $newDB->where('PurchaseOrdersStatus', 1)->get('purchaseorders', null, 'PurchaseOrdersId,PurchaseOrdersNo,PurchaseOrdersDate');

$arr['cashgroups_data'] = $newDB->get('cashgroups');
