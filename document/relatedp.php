  ...
  <?php require('sidebar.php') ?>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <!-- Main Content -->
        ...
        <div class="container">
        <?php
        $thisdoc = $sDB -> query("Select * from Products where ProductsId=?",$_GET['id'])->fetchArray();
        // $lastdoc = $sDB -> query("Select * from DocumentDetail where DocumentId=?",$_GET['id'])->fetchArray();
        // var_dump($lastdoc);
        ?>
        <h1>Sản phẩm : <?php echo $thisdoc['ProductsName'] ?></h1>

        <table class="table">
            <tr>
              <th>Tên sản phẩm</th>
              <td><?php echo $thisdoc['ProductsName'] ?></td>
            </tr>
            <tr>
              <th>Mã</th>
              <td><?php echo $thisdoc['ProductsNumber'] ?></td>
            </tr>
            <tr>
            <th>Miêu tả</th>
              <td><?php echo $thisdoc['ProductsDescription'] ?></td>
            </tr>
              <!--  -->
            </tr>
        </table>
        ...
        <h3>Các tiêu chuẩn liên quan</h3>
          <div class="col-md-12">
            ...
            <tbody>
                  <?php
                  $sql = "Select ad.*,s.*,d.* from DocumentAP ad
