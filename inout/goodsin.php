...
$newDB->orderBy('s.GoodsInputsDate', 'DESC');
$table_data = $newDB->get ("GoodsInputs s", null, "s.GoodsInputsId as id,sco1.SupplyChainObjectName Từ,sco2.SupplyChainObjectName Đến,s.GoodsInputsNo No,s.GoodsInputsDate Ngày,s.GoodsInputsType Kho,s.GoodsInputsTime as Time,CONCAT('<a href=\"print-goodsin.php&quest;id=',s.GoodsInputsId,'\" target=\"_blank\" >','<i class=\"fas fa-print\"></i>', '</a>') as Print");
$table_link = "updateGoodsInput.php?id=";
?>
