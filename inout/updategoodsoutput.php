    ...
    <div class="row p-2 mx-auto mb-5" style="width: 1000px;">
        ...
        <table class="w-100 noborder">
            ...
            <tr>
                ...
                <td><?php echo $GoodsOutput['GoodsOutputsTime']?></td>
            </tr>
            <tr>
        ...
        <table class="items" style="margin-left: auto; margin-right: auto; width: 1000px;">
            ...
            <tbody>
                <form method="post" action="listen-update-goods-output.php">
                <?php
                $totalQty = 0;
                ...
                ?>
                <tr>
                    <td><?php echo $k+1 ?><input type="hidden" name="GoodsOutputItemsId[]" value="<?php echo $item['GoodsOutputItemsId'] ?>"</td>
                    <td><?php echo $product['ProductsName'] ?></td>
                    <td><?php echo $product['ProductsNumber']?></td>
                    <td><?php echo $item['GoodsOutputItemsWo']?></td>
                    <td><input style="height: 30px;font-size:16px;width:110px;" name="GoodsOutputItemsUnitPrice[]" type="number" value="<?php echo $item['GoodsOutputItemsUnitPrice']?>"></td>
                    <td><?php echo $product['ProductsUnit']?></td>
                    <td><input style="height: 30px;font-size:16px;width:60px;" name="GoodsOutputItemsQty[]" type="number" value="<?php echo $item['GoodsOutputItemsQty']?>"></td>
                    <td><input style="height: 30px;font-size:16px;" name="GoodsOutputItemsRemark[]" type="text" value="<?php echo $item['GoodsOutputItemsRemark']?>"></td>
                </tr>
                <?php
                }
        ...
        <script>
            ...
            //        $.ajax({
            //            'url': 'updateGoodsOutputdata.php?name='+e.target.name+'&value='+e.target.value,
            //            'method': 'get'
            //        })
            //     })
            // })
