...
$sql[] = "CREATE TABLE Boms (
    ...
    ProductsId INT(6) UNSIGNED NOT NULL DEFAULT 0,
    BomsQty INT(6),
    ProcessesId INT(6) UNSIGNED DEFAULT 0,
    MakersId INT(6) UNSIGNED DEFAULT 0,
    ClassifiedMaterialsId INT(6) UNSIGNED DEFAULT 0,
    MachinesId INT(6) UNSIGNED DEFAULT 0,
