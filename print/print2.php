...
<body>
    ...
    $pagenum=$startlabel;
    if ($pagenum>=99) {
        echo "Bạn không được in quá 99 label của sản phẩm này trong ngày hôm nay!";
       exit();
    }
    ...
    <div class="page">
        ...
        <tr>
            <td colspan='9'>
                <h2 style='text-align:center; margin:5px;'>PHIẾU CHUYỂN CÔNG ĐOẠN</h2>
                <h3 style='text-align:center; margin:5px;'>(공 정 이 동 전 표)</h3>
            </td>
            <td colspan='2'>
            ...
            <tr>
                ...
                <td colspan='2'><?php  echo date("md",strtotime($date))."-".sprintf('%02d', $pagenum)."-".$shift  ?></td>
...
<td rowspan='2'></td>
<td style='height:25px'>Ngày làm</td>
...
<tr>
<td style='height:25px'>Người làm</td>
<td></td>
<td colspan='2'></td>
</tr>
...
?>
<tr>
    <td colspan='11' style='text-align:left;font-weight:bold;height:30px;'>Ghi chú :</td>
</tr>          
