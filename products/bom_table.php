...
echo "</select></td>";
echo "<td><input type='text' name='BomsPartNo' /></td>";
echo "<td><input type='text' name='BomsPartName' /></td>";
echo "<td><input type='text' name='BomsSize' /></td>";
...
echo "<td><input type='text' name='BomsMaterial' /></td>";
echo "<td><input type='text' name='BomsUnit' /></td>";
echo "<td><input style='max-width: 70px;' type='number' name='BomsQty' /></td>";
echo "<td><input type='text' name='BomsProcess' /></td>";
echo "<td><input type='text' name='BomsMaker' /></td>";
echo "<td><input type='text' name='BomsClassifiedMaterial' /></td>";
echo "<td><input type='text' name='BomsMachine' /></td>";
echo "</form></tr>";
