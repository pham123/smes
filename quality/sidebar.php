...
$arr = array(
  array('createissue.php', 'fas fa-plus-square',$oDB->lang('AddIssue')),
  array('issuelist.php', 'fas fa-list-ol',$oDB->lang('IssueList')),
  array('#', 'fas fa-search',$oDB->lang('FindIssue')),
  array('#', 'fas fa-chart-bar',$oDB->lang('Report')),
);
