          ...
          <form action="listen-update-import.php?id=<?php echo $_GET['id'] ?>" method="post" enctype="multipart/form-data">
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <input type="number" name="ProductsQty" id="" class='form-control' value="<?php echo $import['ProductsQty'] ?>">
                </div>
                <div class="col-md-6">
                  <p><?php echo $oDB->lang('UnitPrice') ?></p>
                  <input type="number" name="ProductsUnitPrice" id="" class='form-control' value="<?php echo $import['ProductsUnitPrice'] ?>">
                </div>
                <div class="col-md-6">
                  ...
                  <select name="ProductsId" id="" class='form-control'>
                    ...
                    foreach ($model as $key => $value) {
                      if($value['ProductsId'] == $import['ProductsId']){
