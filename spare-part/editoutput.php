...
$page_heading = 'UpdateOutput';
$page_css = 'p{margin-bottom: 0px;}.col-md-6{padding-bottom: 10px;}';
require('../views/template-header.php');
require('../function/template.php');
$oDB = new db();

$output = $oDB->sl_one('Outputs', 'OutputsId = '.$_GET['id']);
?>
  ...
  <?php require('sidebar.php') ?>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="">
          <form action="listen-update-output.php?id=<?php echo $_GET['id'] ?>" method="post" enctype="multipart/form-data">
              <div class="row">
                <div class="col-md-6">
                  <p>Product</p>
                  <select name="ProductsId" id="" class='form-control'>
                    ...
                    foreach ($model as $key => $value) {
                      if($value['ProductsId'] == $output['ProductsId']){
                ...
                <div class="col-md-6">
                  <p>Quantity</p>
                  <input type="number" name="ProductsQty" id="" class='form-control' value="<?php echo $output['ProductsQty'] ?>">
                </div>
                <div class="col-md-6">
                  <p>Reason</p>
                  <input type="text" name="ExportsReason" id="" class='form-control' value="<?php echo $output['ExportsReason'] ?>">
                </div>
