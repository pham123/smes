...
$export = $newDB->getOne('Exports e');

$newDB->join("Outputs o", "o.ExportsId=e.ExportsId", "LEFT");
$newDB->join("Products p", "p.ProductsId=o.ProductsId", "LEFT");
$newDB->where('e.ExportsId', $export_id);
$products = $newDB->get('Exports e',null,'p.ProductsNumber,p.ProductsName,p.ProductsDescription,p.ProductsUnit,o.ProductsQty,o.ExportsReason');
  ...
  <body onload="window.print()">
	...
	<tbody>
		<tr>
			...
			<td style="background-color:#d0cece; height:30pt; text-align:center; vertical-align:middle; white-space:normal; width:48pt"><span style="font-size:11pt"><span style="color:black"><span style="font-family:Calibri,sans-serif"><strong>Reason</strong></span></span></span></td>
        </tr>
        <?php
		...
		<tr>
			...
			<td style="height:14.4pt; text-align:center; vertical-align:middle; white-space:nowrap"><span style="font-size:12pt"><span style="color:black"><span style="font-family:Calibri,sans-serif"><?php echo $product['ExportsReason'] ?></span></span></span></td>
        </tr>
        <?php
        }
        ?>
