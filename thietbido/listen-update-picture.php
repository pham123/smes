...
// if everything is ok, try to upload file
	...
	if (move_uploaded_file($_FILES["file"]["tmp_name"], $target_file)) {
		...
		w_logs('../logs/',$content);
		rename($target_file, "../products/image/img_".$id.".jpg");
		
		//thay doi kich thuoc anh
		   $resize = new ResizeImage("../products/image/img_".$id.".jpg");
			$resize->resizeTo(1024, 1024, 'maxWidth');
			$resize->saveImage("../products/image/img_".$id.".jpg");

			$resize = new ResizeImage("../products/image/img_".$id.".jpg");
			$resize->resizeTo(200, 200, 'maxWidth');
			$resize->saveImage("../products/image/small/img_".$id.".jpg");
