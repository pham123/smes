        ...
        <div class="mx-1">
          ...
          <form action="" method="post">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-3">
                <p class="mt-1"><?php echo $newDB->where('MaterialTypesId', $materialtypes)->getOne('materialtypes')['MaterialTypesName']?></p>
              </div>
              ...
              <table style="margin-bottom: 70px;" class="table table-bordered">
                ...
                <tbody>
                  <tr v-for="(item,index) in StockInputitems">
                    ...
                    <td>{{(item.StockInputItemsQty*item.StockInputItemsUnitPrice).format()}}</td>
  ...
  <script>
    ...
    $(function () {
      ...
      new Vue({
        ...
        data: {
          StockInputsId: null,
          MaterialTypesId: <?php echo $materialtypes?>,
          UsersId: '',
          FromId: '',
          ToId: '',
        ...
        created: function(){
          axios.get('/smes/inout/loadStockInputdata.php?mtpid='+this.MaterialTypesId).then(({data}) => {
