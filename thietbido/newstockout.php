...
$getmaterialtypes = (isset($_GET['materialtypeid'])) ? $_GET['materialtypeid'] : 6 ;
$oDB = new db();
        ...
        <div class="mx-1">
          ...
          <form action="" method="post">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-3">
              <p class="mt-1"><?php echo $newDB->where('MaterialTypesId', $getmaterialtypes)->getOne('materialtypes')['MaterialTypesName']?></p>
              </div>
  ...
  <script>
    ...
    $(function () {
      ...
      new Vue({
        ...
        data: {
          StockOutputsId: null,
          MaterialTypesId: <?php echo $getmaterialtypes?>,
          UsersId: '',
          FromId: '',
          ToId: '',
        ...
        created: function(){
          axios.get('/smes/inout/loadStockoutdata.php?mtpid='+this.MaterialTypesId).then(({data}) => {
