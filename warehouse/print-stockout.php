...
<html lang="en">
  ...
  <body onload="window.print()">
    ...
    <div class="row p-2 mx-auto mb-5" style="width: 900px;">
        ...
        <div class="row py-5 px-3">
            <div class="col-12">
                <table class="table-sm" style="width: 800px;margin-left: auto; margin-right: auto;">
                    <thead>
                        <tr>
                            <th style="width: 160px;"><strong>Delivered by</strong><br>(Người giao hàng)</th>
                            <th style="width: 160px;"><strong>Checked by</strong><br>(Xác nhận)</th>
                            <th style="width: 160px;"><strong>Inspect by</strong><br>(Người kiểm tra)</th>
                            <th style="width: 160px;"><strong>Guard</strong><br>(Bảo vệ)</th>
                            <th style="width: 160px;"><strong>Received by</strong><br>(Người nhận hàng)</th>
                        </tr>
                    </thead>
                    <tbody>
